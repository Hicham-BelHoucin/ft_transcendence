...
const Modal = ({
  ...
  return (
    <div className="animation-fade absolute left-[50%] top-[50%] -translate-x-1/2 -translate-y-1/2 z-20 flex h-screen w-screen items-center justify-center animate-duration-500">

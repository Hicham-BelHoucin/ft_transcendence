          ...
          <button
            className={`
              ${variant === "contained"
                ...
                bg-primary-500 px-4 py-2 font-bold text-secondary-500 hover:ring-2 hover:ring-primary-500 hover:ring-opacity-40 hover:shadow-primary-500 hover:shadow-[0px_0px_6px] transition ease-in-out duration-400`
                : variant === "outlined"

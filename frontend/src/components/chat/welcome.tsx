...
const Welcome = ({className, setShowModal} : {className: string, setShowModal: React.Dispatch<React.SetStateAction<boolean>>;
  ...
  return (
    <div className={clsx("relative overflow-hidden col-span-10 flex h-screen  w-full items-center justify-center flex-col gap-4 bg-secondary-50 md:col-span-7 max-wd-md animate-fade-right border-l-[1px] border-secondary-500 ", className && className )}>
